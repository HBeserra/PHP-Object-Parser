...
exports.phpObjectParser = void 0;
function phpObjectParser(objStr) {
    let idx = 0;
    let ridx = 0;
    let refStack = [];
    return new Promise((resolve, reject) => {
        ...
        function readString(expect = '"') {
            ...
            const value = objStr.substring(idx, idx + utfLength);
            idx += utfLength + 2;
            return value;
        }
...
exports.phpObjectParser = phpObjectParser;
